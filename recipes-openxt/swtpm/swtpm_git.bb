...
DEPENDS = "devscripts equivs build-essential libtasn1-dev pkg-config automake autoconf bash coreutils expect libtool sed fuse net-tools python3 python3-twisted trousers tpm-tools socat libseccomp-dev libfuse-dev libglib2.0-dev"
DEPENDS += "libtpms"
